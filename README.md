...
My research is centered around developing network on chip for hardware accelerators targeting sparse linear algebra under Prof. Daniel Sanchez. Outside of making hardware run fast or , I really playing bass for MIT's Jazz Combos, DJing, and I love Muay Thai.
